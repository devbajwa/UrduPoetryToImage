...
/*document.addEventListener("DOMContentLoaded", function () {
    ...
    convertButton.addEventListener("click", function () {
        ...
        const svgBlob = new Blob([htmlContent.outerHTML], { type: "image/svg+xml;charset=utf-8" });
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  convertButton.addEventListener("click", function () {
    console.log('sss');
    // Use html2canvas to capture the HTML content and convert to an image
